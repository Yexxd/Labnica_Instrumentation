...
public class Tank : MonoBehaviour
{
    ...
    //Cantidad a la que se reduce el liquido (En este caso aunque el número es pequeño es necesario debido a la escala de los obj de escena)
    public float m_Redliquido = 0.035f;

    private float m_delay = 0.7f; 
    private float m_TamañoTanque = 0.75f; 
    ...
    {
        if (m_EscalaLiq.y <= m_TamañoTanque)
        {
